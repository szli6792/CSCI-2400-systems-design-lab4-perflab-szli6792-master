...
##
CXXFLAGS= -g -O2 -fopenmp -march=native -lpthread -floop-parallelize-all -ftree-parallelize-loops=8 -funroll-loops -freciprocal-math -ffast-math -fno-omit-frame-pointer -Wall
